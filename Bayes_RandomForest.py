...
search_space = [Integer(50, 300, name='n_estimators'), Categorical(["sqrt","log2"],name="max_features"),
...
print('Best Parameters: criterion = %s, max_features=%s, n_estimators=%d' % (result.x[2], result.x[1], result.x[0]))
